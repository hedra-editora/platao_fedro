\chapterspecial{Introdução}{Qual é o verdadeiro tema do Fedro?}{}


\epigraph{Dar"-te"-ei o esplêndido caduceu da felicidade e da riqueza,\ dourado, de
...
Zeus.}{Apolo a seu irmão Hermes (Hino Homérico a Hermes v. 529--532)} 

 

``\emph{Fedro} ou acerca do amor, ético''\footnote{Tomo aqui como parâmetro um dos títulos empregados por Hermias: ``Qual é
o verdadeiro escopo do diálogo (\emph{Tís ho alêthès toũ dial\gr{ό}gou
skop\gr{ό}s})'' (Herm. \emph{In Phdr}~63.26 Couvreur = 10, 24 Lucarini 1
Moreschini).} 
(\emph{Phaîdros ê perì érôtos, êthikós} D.L.§58), essa é a maneira pela
qual Diógenes Laércio apresenta, no seu catálogo das obras de Platão, a
definição do tema e do gênero do diálogo. Um pouco antes, Diógenes diz
que segundo autores mais antigos o \emph{Fedro} guardava um estilo
juvenil (\emph{meirakiôdés}), pois estaria entre os primeiros escritos
de Platão, e que Dicearco especificamente teria considerado seu estilo
vulgar (\emph{phortikón}) (D.L.§38). Essas, entre outras informações,
fazem parte da interessante biografia de Platão feita por Diógenes, meio
pelo qual sabemos, por exemplo, como Trasilo organizou os diálogos, tal
qual já haviam sido organizadas as tragédias (D.L.§56--60), segundo
tetralogias.
...
filosofia (\emph{êthikós kaì kathartikòs, elegktikòs, protreptikòs eis
...
acerca dos ``deuses encósmios'' (\emph{In Plat. Tim.}
32c).\footnote{Cf. Brisson, L.~\emph{Proclus et l'orphisme}~In~\emph{Proclus, lecteur
et interprète des anciens}, Paris: Les Belles Letres, 1987, p.84--86;
Berg, R\,M\,van den.~\emph{Proclus' hymns}: essays, translations and
commentary, Köln: Brill, 200; Saffrey, H\,D.~\emph{Accorder les
traditions théologiques: une caractéristique du néoplatonisme athénien},
In~\emph{Le Néoplatonisme après Plotin}, Paris: Vrin, 2000, p.143--158.} 
...
(\emph{dzetêtikoí}). Isso ocorre quando há mistura do diálogo com uma
...
[sp.], \emph{Do método terrível}, 36.30--33).\footnote{\gr{Διαλόγου}~\gr{πλοκὴ}~\gr{ἠθικοὶ}~\gr{λόγοι}~\gr{καὶ}~\gr{ζητητικοί}.~\gr{ὅταν}~\gr{ἀναμίξῃς}~\gr{προσδιαλεγόμενος}~\gr{καὶ}~\gr{ζητῶν},~\gr{οἱ}~\gr{ἠθικοὶ}~\gr{παρεμβληθέντες}~\gr{λόγοι}~\gr{ἀναπαύουσι}~\gr{τὴν}~\gr{ψυχήν},~\gr{ὅταν}~\gr{δ}'~\gr{αὖ}~\gr{ἀναπαύσηται},~\gr{ἐπάγεται}~\gr{ἡ}~\gr{ζήτησις},~\gr{ὥσπερ}~\gr{ἐν}~\gr{ὀργάνῳ}~\gr{ἡ}~\gr{τάσις}~\gr{καὶ}~\gr{ἄνεσις}~\gr{γίνεται}.} 
\end{quote}
...
si''(264c). \footnote{Cf. Trivigno (2009) que estuda esse aparente paradoxo, de Platão
defender uma prescritiva retórica que ele mesmo não teria seguido.} 
...
diante, pressupõe"-se uma conversão (protrepse), uma mudança ética, uma
mudança na ação e no discurso, uma cura da cegueira.
...
há inúmeras maneiras, mais ou menos interessantes, de dividir o
\emph{Fedro}.
...
próximas do sacro (\emph{hieros}), pois a linguagem encontra seus
...
discursos escritos, das imagens (\emph{eikona}), pois tudo isso tem
...
\gr{ψυχᾶι}~\gr{χάριν} \gr{οὓς} \gr{ἐπιστρατεύσηι},\\
 ...
 \gr{μηδ}'
\gr{ἄρρυθμος} \gr{ἔλθοις}.\\!

\{Co.\} Eros, Eros, o que pela visão\\
 mobiliza o desejo, doce
condutor\\
...
\gr{οὐδ}' \gr{αὖ} \gr{γυναῖκας}, \gr{ἀλλὰ} \gr{καὶ} \gr{θεῶν} \gr{ἄνω}\\
 \gr{ψυχὰς}~\gr{χαράσσει} \gr{κἀπὶ} \gr{πόντον}
\gr{ἔρχεται}·\\!

Eros, o deus mais invencível de todos.\\
 Pois Eros não chega só para os
homens,\\
 nem só para as mulheres, mas atinge também\\
 as almas dos
elevados deuses, bem como as conduz ao mar.\\!
...
mobilizam um amante, a tal ponto dele considerar o amado um auriga seu,
ou seja, um condutor de seu impulso amoroso. Há uma relação entre o
olhar puro do amado, sua figura e a afecção do amante, que descreve
justamente esse conduzir da alma:
...
por toda a Ática ou para qualquer outro lugar que queiras. (Pl.
\emph{Phdr}. 230d6-e1).
\end{quote}
...
apresenta, não só no \emph{Fedro}, mas também no
\emph{Banquete}~(180c-181d), entre dois tipos de Amores. Quanto aos dois
Eros, um deles é vulgar e outro nobre, assim como há uma maneira vulgar
de usar a linguagem, a retórica e a logografia, e uma nobre, a
filosofia. Tal qual no discurso de Pausânias no \emph{Banquete}, no
\emph{Fedro} é evidente também que concorrem esses mesmos dois Eros, ou,
na linguagem de Pausânias, um Eros Pandêmio e um Urânio, filhos de duas
Afrodites distintas.
...
(Hes.\emph{Th}.116--120).\footnote{Cf. Torrano, \versal{JAA}, especialmente sua introdução à \emph{Teogonia} de
Hesíodo, São Paulo: Iluminuras, 1995, p\,39--48.}  Então, desde esse
prisma, o tema do \emph{Fedro}, talvez o mais importante, seja mesmo
Eros em suas múltiplas acepções, especialmente na sua relação com a
Alma, e essa tensão que se revela no \emph{lógos}.
...
(\gr{διπλοῦς} \gr{θεὸς} \gr{ὁ} \gr{Ἔρως})''\footnote{Luciano Samósata, \emph{Amores} 37,7.} , de modo que Eros unifica
o diverso por ser duplo. Há uma proximidade entre Eros, Phanes e
Protogonos, pelo que fica claro que o Platão assimilou muitos elementos
da cosmogonia órfica na sua filosofia, e a interpretação dessa
assimilação se acentua no neoplatonismo.\footnote{Cf. Kern, O\,\emph{Orphicorum Fragmenta}, Zurich: Weidmann,1972; Sorel,
R\,\emph{Les cosmogonies grecques}, Paris: \versal{PUF}, 1994; Barnabé, A\,\emph{Platón y el orfismo}, Madrid: Agapea, 1990.} 
...
(\emph{eikona}; \emph{eidôlon}), como único recurso possível, ou o mais
...
demonstrativo nunca foi a especialidade de Lísias, que escreveu
sobretudo discurso jurídico. Como meteco, Lísias só pôde pisar no
tribunal ateniense por um curtíssimo período em que foi aceito como
cidadão e rapidamente teve esse direito revogado.
...
gês}) (D'Alfonso, 1994, p.19).\footnote{I danzatori che nella strophe si muovono verso destra (o sinistra)
simbolizzano il movimento del cosmo, nell'antistrophe, esequendo il
movimento contrario, sono espressione del movimento del sole o dei
pianeti, mentre com il canto sul posto (epodo) raffigurano la
\emph{stásis tês gês}.} 
...
movimento mudo de parte do coro, cujos os cantos poderiam soar
combinados agora com uma dança silenciosa, imitando sempre a
complexidade dos fenômenos celestes. Em seu exímio trabalho em torno de
Estesícoro, D'Alfonso aponta para a analogia, muito valiosa, entre o
movimento celeste e o do coro, reforçando elementos de religião"-astral
em Estesícoro e em Platão.
...
(\emph{hedraîon}) terrestre.\footnote{Siriano.~\emph{Commentarium in Hermogenis
librum}~\gr{περὶ}~\gr{ἰδεῶν},~\emph{Syriani in Hermogenem commentaria,}~vol. 1,
...
(\emph{eidolon}) e do \emph{lógos} sobre as almas.
...
extramuros (\emph{exo teíchous}), fora da cidade, uma vez que a
...
fundasse uma escola.\footnote{Cf. Córdova, Aquino, Juárez y Vidal;~\emph{Oratória griega y oradores
áticos del primer period}, México: Unam, 2004, p.27--34; 93--120.
...
pelo rico resultado. Rowe (1986) em sua edição bilíngue faz com que sua
tradução privilegie a fluidez, pois não recorta o diálogo em subseções e
não carrega de notas, reservando seus comentários ao texto grego,
bastante importantes aliás, à seção final.
...
\section{Edições, traduções e comentários}
...
\item
  ...
  \emph{História, Ciências, Saúde} -- Manguinhos, Rio de Janeiro: \versal{VI} (2)
  1999.
\item
...
\item
  ...
  Malta, André. Porto Alegre: L\&\versal{PM}, 2014.
\item
...
\item
  Córdova, Aquino, Juárez \& Vidal; \emph{Oratória griega y oradores
  áticos del primer periodo}; México: Unam, 2004.
\item
...
\item
  D'Alfonso, F\,\emph{La ``choreía'' astrale in um passo
