...
\tit{Aristotelis}.~\emph{Physica}. Ed. W.D.~Ross.~Oxford: Clarendon Press,
  1950, Repr. 1966.
\tit{Aristotle}.~\emph{On Rhetoric}. Trad. \versal{G.A.}~Kennedy. Oxford: Oxford
...
\tit{Campbell, D.}~\emph{Greek Liric}~\versal{III}, Harvard University Press,
  1991.
...
\tit{Cardoso, D.}~\emph{A~alma como centro do filosofar de Platão}, São
  Paulo: Loyola, 2006.
\tit{Casadio, G.}~\emph{La metempsicosi tra Orfeo e Pitagora}, In
...
\tit{Graves, R.}~\emph{The Greek Myths}. Middlesex, England: Penguin Books, 1960.
...
\tit{Heath, M.}~The unity of Plato's Phaedrus. In: \emph{Oxford Studies in
  Ancient Philosophy}. Oxford, 1989, p.151-173, vol.~\versal{VII}. 
\tit{Heath, M.}~The unity of the Phaedrus: a postscript. n: \emph{Oxford Studies in
...
\tit{Robinson, T.M.}~The argument for immortality in
  Plato's~\emph{Phaedrus}. In: \versal{Anton, J. \& Kustas, G.} (eds.). Essays in ancient Greek Philosophy.
  Nova York: \versal{NY} Press, 1971.
...
\tit{Rowe, C.}~The unity of the Phaedrus: a replay to Heath. \emph{Oxford Studies in Ancient Philosophy}, vol. \versal{VII}, 1989.
