...
\bekker{[227a]} S: Ó querido Fedro, de onde vens e para onde vais?
...
versão, de que ela foi (\emph{hērpásthē}) raptada de lá e não daqui\endnote{Segundo Acusilao (DK, 9, B, 35) o rapto de Orítia por
...
(\emph{hēurēkénai}) o fármaco do meu êxodo.\endnote{Uma vez
  ...
  (\emph{Rep}.VII 514b).} Tal como os que agitam um
...
e imortal (\emph{thnetón te kaì athánaton})\endnote{cf. Heráclito, DK,
  12, B 62: \emph{athánatoi thnêtoí, thnêtoì athánatoi} {[}\ldots{}{]}.} .~Toda alma ocupa"-se
...
\bekker{[267a]} S: Quem mais se não ele? O qual disse haver nas composições
...
pois só por ter colhido de algum livro\endnote{Ao expor a pseudo-arte,
